...
REM ERROR StatusLogger No log4j2 configuration file found. Using default configuration: logging only errors to the console.
echo on
java -Dlog4j.configuration=file:///%APP_HOME%/src/main/resources/log4j.properties ^
