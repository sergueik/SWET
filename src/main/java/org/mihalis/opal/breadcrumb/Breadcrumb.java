...
// origin: https://raw.githubusercontent.com/lcaron/opal/master/src/main/java/org/mihalis/opal/breadcrumb/Breadcrumb.java
// store a replica locally for eclipse 
/**
...
public class Breadcrumb extends Canvas {
	...
	private static Color START_GRADIENT_COLOR = new Color(display, 255, 255, 255);
	private static Color END_GRADIENT_COLOR = new Color(display, 224, 224, 224);

	static Color BORDER_COLOR = new Color(display, 128, 128, 128);
	static Color BORDER_COLOR_1 = new Color(display, 212, 212, 212);
	static Color BORDER_COLOR_2 = new Color(display, 229, 229, 229);
	static Color BORDER_COLOR_3 = new Color(display, 243, 243, 243);
